...
const Home = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
            ...
            {/* Main Content */}
            <main className="container mx-auto px-6 relative z-20 -mt-24 pb-16">
                <div className="flex flex-col md:flex-row items-end justify-between mb-12 gap-8">
                    <div>
                        <h2 className="text-3xl md:text-4xl font-bold text-white mb-3 drop-shadow-lg">Öne Çıkan İlanlar</h2>
                        <p className="text-slate-100 text-lg drop-shadow-md">Sizin için seçtiğimiz en özel portföyler</p>
                    </div>
